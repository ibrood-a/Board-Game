...
bool board::moveType(int moveDistance, bool solvingPuzzle) {
	...
	swap(tempPuzzle[zeroIndex], tempPuzzle[zeroIndex + moveDistance]);
	...
	board* tempBoard = new board(tempPuzzle, zeroIndex + moveDistance);
